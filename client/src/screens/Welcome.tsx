      ...
      {email &&
        <div className='mx-auto'>
          ...
          <div className="d-flex row mx-auto">
            <div className=' ms-auto col-sm-12 col-xl-5 col-lg-5 col-md-5 text-start p-2 mt-4 rounded shadow-lg bg-dark p-5'>
                ...
                <div>
                  ...
                  {(availslots.length !== 0 && count !== 0) &&
                    <div className=' rounded mx-auto p-2'>{availslots.map((ele: any,id:any) => {
                      return <div key={id} className='slot-button btn border border-3 rounded m-2' onClick={() => { setchosenslot(ele); }}>{ele}</div>
                    })}</div>
                  }
